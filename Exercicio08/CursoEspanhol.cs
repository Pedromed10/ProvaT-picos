...
{
    public CursoEspanhol(string nome, int duracao) : base(nome, duracao)
    {
    }
    ...
    public override void GerarCertificado()
    {
        if (CalcularMedia() >= 7)
            ...
            Console.WriteLine($"Aluno não atendeu aos requisitos para o certificado do curso de Espanhol: {Nome}");
    }
}
